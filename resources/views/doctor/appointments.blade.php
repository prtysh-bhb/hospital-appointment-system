                    ...
                    <div class="flex-1">
                        <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-gray-500">ID: PT-2024-001 • Age: 45 • Male</p>
                            </div>
                        </div>
                    ...
                    <div class="flex-1">
                        <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-gray-500">ID: PT-2024-002 • Age: 52 • Female</p>
                            </div>
                        </div>
                        <div class="mt-3 space-y-2">
                    ...
                    <div class="flex-1">
                        <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-gray-500">ID: PT-2024-003 • Age: 38 • Male</p>
                            </div>
                        </div>
                        <div class="mt-3 space-y-2">
                    ...
                    <div class="flex-1">
                        <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
                            ...
                            <div>
                                ...
                                <p class="text-xs sm:text-sm text-gray-500">ID: PT-2024-004 • Age: 29 • Female</p>
                            </div>
                        </div>
                        <div class="mt-3 space-y-2">
