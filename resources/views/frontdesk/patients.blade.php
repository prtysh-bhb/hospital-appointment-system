            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                        <p class="text-xs sm:text-sm font-medium text-gray-900">PT-2024-001</p>
                    </td>
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                        <p class="text-xs sm:text-sm font-medium text-gray-900">PT-2024-002</p>
                    </td>
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center gap-2 sm:gap-3">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                        <p class="text-xs sm:text-sm font-medium text-gray-900">PT-2024-003</p>
                    </td>
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center gap-2 sm:gap-3">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                        <p class="text-xs sm:text-sm font-medium text-gray-900">PT-2024-004</p>
                    </td>
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center gap-2 sm:gap-3">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                        <p class="text-xs sm:text-sm font-medium text-gray-900">PT-2024-005</p>
                    </td>
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center gap-2 sm:gap-3">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                        <p class="text-xs sm:text-sm font-medium text-gray-900">PT-2024-006</p>
                    </td>
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center gap-2 sm:gap-3">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                        <p class="text-xs sm:text-sm font-medium text-gray-900">PT-2024-007</p>
                    </td>
                    <td class="px-3 sm:px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center gap-2 sm:gap-3">
